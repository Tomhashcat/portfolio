...
function EventsPage() {
    ...
    return (
        ...
        <>
            ...
            <a href="https://github.com/Tomhashcat/Debuggez-une-application-React.JS-main" aria-label="GitHub Profile"><FontAwesomeIcon className="icones" alt="icon github" icon={faGithub}/></a>
